...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-white sticky-top navbar-light p-3 shadow-sm">
		<div class="container">
		    <a class="navbar-brand" href="#"><i class="fa-solid fa-shop me-2"></i> <strong>TK HOTEL</strong></a>
		    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
		      <span class="navbar-toggler-icon"></span>
		    	...
		    	<div class=" collapse navbar-collapse" id="navbarNavDropdown">
				    ...
				    <ul class="navbar-nav ms-auto ">
				        <li class="nav-item">
				         	<a class="nav-link mx-2 text-uppercase" href="{{URL::to('/giohang')}}"><i class="fa-solid fa-cart-shopping me-1"></i> Cart</a>
				        </li>
				        <li class="nav-item">
                        ...
                        <li class="nav-item">
				         	<a class="nav-link mx-2 text-uppercase" href="{{URL::to('/')}}"><i class="fa-solid fa-cart-shopping me-1"></i> Đăng xuất</a>
				        </li>
				    </ul>
		    	</div>
                                ...
                                <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                    ...
                                    <div class="d-flex flex-column mt-4">
                                        ...
                                        <button class="btn btn-outline-primary btn-sm mt-2" type="button">
                                            <a href="{{URL::to('/xemthongtinphong/' .$value->id)}}">Xem phòng</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
