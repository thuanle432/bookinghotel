...
<body>
    ...
    <h1 class="text-center">Liệt kê phòng</h1>
    <section class="intro">
            ...
            <div class="container">
                ...
                <div class="col-12">
                    ...
                    <table class="table  table-bordered mb-0">
                        ...
                        <tr>
                            <th><img style="width: 200px" src="{{URL::to('public/frontend/image/'.$value->product_image)}}" /></th>
                            <td>{{ $value->product_name}}</td>
                            <td>{{ $value->product_infor}}</td>
                            <td>{{number_format( $value->product_price). ' VNĐ'}}</td>
                            <td><a href="{{URL::to('/suaphong/'. $value->id)}}">Sửa</a></td>
                            <td><a href="{{URL::to('/xoaphong/'. $value->id)}}">Xoá</a></td>
                        </tr>
                        @endforeach
