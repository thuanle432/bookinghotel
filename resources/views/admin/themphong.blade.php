...
<body>
    ...
    <!-- form -->
    <form class="form-horizontal"  method="post" action="{{URL::to('/luuphong')}}" id="form">
		{{csrf_field() }}
        <fieldset>
        <legend class="text-center">Thêm phòng</legend>

            <div class="form-group">
                <label class="col-md-4 control-label" for="product_name">Tên phòng</label>  
                <div class="col-md-4">
                    <input id="product_name" name="product_name" placeholder="Nhập tên phòng" class="form-control input-md" required="" type="text">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="product_infor" name="product_infor" placeholder="Nhập thông tin phòng" class="form-control input-md" required="" type="text">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="product_price" name="product_price" placeholder="Nhập giá phòng" class="form-control input-md" required="" type="text">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="product_image" name="product_image" placeholder="Ảnh" class="form-control input-md" required="" type="file">
